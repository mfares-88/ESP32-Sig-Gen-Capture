...
class ToonConverter {
     ...
     * @private
     */
    static toToonString(value, depth) {
        // Handle null
        if (value === null) {
            return 'null';
        }
     ...
     * @private
     */
    static toToonObjectCompact(value) {
     ...
     * @private
     */
    static formatCompactTimestamp(date) {
        return date
            .toISOString()
     ...
     * ```
     */
    static convertToJson(toonString) {
        try {
            ...
            try {
                ...
                throw new Error(`Failed to parse TOON string: ${error instanceof Error ? error.message : String(error)}`);
            }
        }
    }
    /**
     ...
     * @private
     */
    static parseCompactTimestamp(timestamp) {
     ...
     * @private
     */
    static parseKeyValue(pair, result) {
 ...
 * @private
 */
ToonConverter.REVERSE_KEY_MAP = Object.fromEntries(Object.entries(ToonConverter.KEY_MAP).map(([long, short]) => [short, long]));
//# sourceMappingURL=ToonConverter.js.map